// src/routes/dashboard/CeritaDashboard.tsx
...
export default function CeritaDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      let query = supabase
        .from("cerita")
        .select("cerita_id, bahasa_id, status, tanggal_dibuat")
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold mb-4">📖 Dashboard Cerita</h1>
      ...
      <div className="p-4 bg-white rounded-xl shadow">
        <h2 className="text-lg font-semibold">Total Cerita</h2>
      ...
      {/* Status Pie */}
      <div className="bg-white rounded-xl shadow p-4">
        <h2 className="text-lg font-semibold mb-2">Status Cerita</h2>
